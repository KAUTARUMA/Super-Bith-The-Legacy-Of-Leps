...
local twerkingRickSettings = {
	...
	frames = 34,
	framestyle = 0,
	framespeed = 1, -- number of ticks (in-game frames) between animation frame changes
...
npcManager.setNpcSettings(twerkingRickSettings)
...
--Register events
function twerkingRick.onInitAPI()
	npcManager.registerEvent(npcID, twerkingRick, "onTickNPC")
	--npcManager.registerEvent(npcID, twerkingRick, "onTickEndNPC")
	--npcManager.registerEvent(npcID, twerkingRick, "onDrawNPC")
	--registerEvent(twerkingRick, "onNPCKill")
end

function twerkingRick.onTickNPC(v)
