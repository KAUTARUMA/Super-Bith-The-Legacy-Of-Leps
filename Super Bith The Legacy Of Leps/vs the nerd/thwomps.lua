...
thwomps.sharedSettings = {
	...
	--lua settings
	slamspeed = 4, --Speed at which thwomp slams. Values above 8 will act a little weird due to vanilla physics.
	acceleration = 0.2, --Rate at which thwomp accelerates. Zero instantly reaches slamspeed.
