...
npcManager.setNpcSettings(incredibleSettings)
...
function incredible.onInitAPI()
	registerEvent(incredible, "onNPCHarm")
end

function incredible.onNPCHarm(token,v,harm,c)
